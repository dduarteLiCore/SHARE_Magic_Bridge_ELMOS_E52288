"""
MagicBridge runner - carga datos HMF
...
# Pre-cargar hmf_loader en sys.modules para que los imports del .pyc funcionen
...
_main_pyc = os.path.join(bin_dir, "1_cargar_datos_v3.cpython-311.pyc")
